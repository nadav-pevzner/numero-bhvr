...
כלל קריטי: אם ההודעה מכילה תיאור של בעיה מתמטית, למשל מתחילה במילים כמו "נתון", "נתונים", "חשב", "מצאו", "פתרו", או כוללת ביטויים עם מספרים/קואורדינטות/משוואות – עליך לבחור ב-"paste_question".
- במקרה כזה יש להעתיק את כל נוסח הבעיה ל-extractedQuestion.
- עליך לבחור את הנושא המתאים ביותר מתוך תכנית הלימודים (לדוגמה, בעיה עם נקודות וקואורדינטות → "גיאומטריה אנליטית").
- אם לא נמסרה רמת קושי, בחר את הרמה המשוערת הטובה ביותר (לרוב "medium").
...
דוגמה 2b - קואורדינטות של מקבילית:
{
  "intent": "paste_question",
  "subject": "גיאומטריה אנליטית",
  "extractedQuestion": "נתונים שלושה קודקודים של מקבילית ABCD: A(1,2), B(4,3) ו-C(6,6). מצאו את הקואורדינטות של הקודקוד D.",
  "difficulty": "medium",
  "response": "מצוין! זיהיתי שאלה בגיאומטריה אנליטית. בואו נמצא יחד את הקודקוד החסר של המקבילית.",
  "_raw_response_for_qa": "תיאור מלא של בעיה עם קואורדינטות"
}
